                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="POST" action="{{ route('checkout-create', $item->id) }}">
                                    ...
                                    <input type="text" class="form-control mb-2 mr-sm-2" style="width: 50px;"
                                        id="nationality" required name="nationality" placeholder="Nationality">
                                ...
                                <p class="disclaimer mb-0">
                                    You are only able to invite member that has registered in tripMuuu.
                                </p>
                            </div>
                        ...
                        <div class="card card-details card-right">
                            ...
                            <div class="bank">
                                <div class="bank-item mb-3">
                                    <img src="{{ url('frontend/images/bank.svg') }}" alt="" class="bank-image">
                                    <div class="description">
                                        <h3>PT TRIPMUUU ID</h3>
                                        <p>0881 8829 8800
                                            <br>
                                            BANK CENTRAL ASIA
                                        </p>
...
@push('addon-script')
    ...
    <script>
        ...
        $('.datepicker').datepicker({
            ...
            icons: {
                rightIcon: '<img src="{{ url('frontend/images/calendar.svg ') }}" style="width:20px;">'
            }
        });
        // }));
